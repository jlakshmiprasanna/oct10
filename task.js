...
let cartItems = ['Laptop', 'Headphones', 'Phone'];
...
let plan = prompt("Choose a subscription plan:  Premium, VIP");
switch(plan) {
    case 'Basic':
...
if (confirmBooking) {
    ...
    setTimeout(confirmRideBooking, 5000); 
} else {
...
let quality = prompt("Select video quality: 480p, 720p, 1080p");
